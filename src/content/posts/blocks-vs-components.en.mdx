export const meta = {
  ...
  description:
    'The core architectural split in viddir — disposable blocks read i18n and wire content, durable components render anything you feed them.',
  created_at: '2026-05-28',
  author_name: 'viddir Team',
  author_image: '/logo.png',
};

Every template promises "easy customization," then makes you grep through twelve files to change a headline. viddir avoids that with one rule:
